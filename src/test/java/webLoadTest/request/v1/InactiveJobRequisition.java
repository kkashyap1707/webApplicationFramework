...
public class InactiveJobRequisition implements IRequestPostNew {

    public Response sendRequest(Map body) {

        return 	RequestUtil.createPostRequest(body, GlobalVars.BASE_URL,"/","upload/v1/requisition/inactivate/");
    }
