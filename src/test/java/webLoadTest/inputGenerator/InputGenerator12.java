package webLoadTest.inputGenerator;
...
public  class InputGenerator12 {
    ...
    //public static String firstInterviewerEmailBlank = faker.bothify(InputGenerator.faker.name().username()+"@allyo.com");
